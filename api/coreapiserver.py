...
FIELD_MAPPING = {
    ...
    "user_email":    "email",
    "pass_email":    "pass_email",  # приймаємо plaintext/хеш у первинному полі
    "user_name":     "username",
    "user_access":   "role",
    "user_id":       "useradminId",
...
# Додаємо псевдонім, щоб читати і альтернативну колонку passwordHash, якщо вона є
REVERSE_FIELD_MAPPING = {v: k for k, v in FIELD_MAPPING.items()}
REVERSE_FIELD_MAPPING.setdefault("passwordHash", "pass_email")
